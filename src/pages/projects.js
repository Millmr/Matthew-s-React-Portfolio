                        ...
                        <div className="projects">
                            <div className="row">
                                ...
                                <div className="col-md-3 work">
                                    ...
                                    <p id="repo"><a href="https://github.com/Millmr/Random-Password-Generator">Check out the code!</a></p>
                                </div>
                                <div className="col-md-1"></div>
                                ...
                                <div className="col-md-3 work">
                                    ...
                                    <p id="repo"><a href="https://github.com/Millmr/Work-Day-Scheduler">Check out the code!</a></p>
                                </div>
                            </div>
                            <br />
                            <br />
                            <div className="row">
                                ...
                                <div className="col-md-3 work">
                                    ...
                                    <p id="repo"><a href="https://github.com/Millmr/weather-dashboard">Check out the code!</a></p>
                                </div>
                                <div className="col-md-1"></div>
                                <div className="col-md-2"></div>
                                <div className="col-md-3 work">
                                    ...
                                    <p id="repo"><a href="https://github.com/Millmr/Employee-Find">Check out the code!</a></p>
                                </div>
                            </div>
                            <br />
                            <br />
